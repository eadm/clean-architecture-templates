...
<recipe>
    <#if isCreateCacheDataSource!false>
        ...
        <open file="${escapeXmlAttribute(srcOut)}/data/${camelCaseToUnderscore(featureName)}/source/${cacheDataSourceName}.kt" />
    </#if>
    ...
    <#if isCreateRemoteDataSource!false>
        ...
        <open file="${escapeXmlAttribute(srcOut)}/data/${camelCaseToUnderscore(featureName)}/source/${remoteDataSourceName}.kt" />
    </#if>
    ...
    <#if isCreateRepository!false>
        ...
        <open file="${escapeXmlAttribute(srcOut)}/data/${camelCaseToUnderscore(featureName)}/repository/${repositoryName}Impl.kt" />
    </#if>
</recipe>
